...
import { Float, Html, Outlines, Text3D, useGLTF } from '@react-three/drei';
      ...
      <group {...props} dispose={null} ref={roomRef}>
        ...
        <group ref={everythingRef}>
          ...
          >
            ...
            {isPointerOver && (
              <>
                <Outlines thickness={0.05} color={new THREE.Color('purple')} />
              </>
            )}
            <DissolveMaterial
              baseMaterial={materials.Objs5_Baked}
...
// function Loop({ boxRef }) {
//   const { camera, clock } = useThree();
//   const target = new THREE.Vector3();

//   // Define the control points for the spline curve
//   const points = [
//     new THREE.Vector3(18.779424788883275, 5.114732519462178, 15.81515247860525),
//     new THREE.Vector3(15.779424788883275, 6.114732519462178, 13.81515247860525),
//     new THREE.Vector3(12.779424788883275, 6.114732519462178, 10.81515247860525),
//     new THREE.Vector3(10.779424788883275, 10.114732519462178, 2.81515247860525),
//     new THREE.Vector3(9.5, 10.114732519462178, 1.5),
//   ];
...
//     if (camera && boxRef.current) {
//       // Increase t by delta time, multiplied by the speed
//       t += delta * speed;

//       // Get the point on the curve corresponding to the current time, clamped to a maximum of 1
