...
export function Room(props: JSX.IntrinsicElements['group']) {
  ...
  useFrame((_state, delta) => {
    ...
    boxRef.current.position.x -= Math.sin(delta);
  });
...
function Loop({ boxRef }) {
  ...
  const points = [
    ...
    new THREE.Vector3(18.779424788883275, 12.114732519462178, 8.81515247860525),
    new THREE.Vector3(18.779424788883275, 12.114732519462178, 7.81515247860525),
    new THREE.Vector3(18.779424788883275, 12.114732519462178, 6.81515247860525),
  ];
