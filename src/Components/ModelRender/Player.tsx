...
export default function Player(props) {
  ...
  const onFadeOut = () => setVisibleItem(true);
        ...
        <group name="Scene">
          <group name="rig003" userData={{ name: 'rig.003' }}>
            <group name="Belt" userData={{ name: 'Belt' }}>
              ...
              >
                <DissolveMaterial
                  baseMaterial={materials['Material.330']}
                  visible={visibleItem}
                  onFadeOut={onFadeOut}
                  color="#0082b2"
                />
              ...
              >
                <DissolveMaterial
                  baseMaterial={materials['Material.329']}
                  visible={visibleItem}
                  onFadeOut={onFadeOut}
                  color="#0082b2"
                />
            ...
            <group name="body001" userData={{ name: 'body.001' }}>
              ...
              >
                <DissolveMaterial
                  baseMaterial={materials['Material.363']}
                  visible={visibleItem}
                  onFadeOut={onFadeOut}
                  color="#0082b2"
                />
              ...
              >
                <DissolveMaterial
                  baseMaterial={materials['Material.361']}
                  visible={visibleItem}
                  onFadeOut={onFadeOut}
                  color="#0082b2"
                />
            ...
            >
              <DissolveMaterial
                baseMaterial={materials['Material.337']}
                visible={visibleItem}
                onFadeOut={onFadeOut}
                color="#0082b2"
              />
            ...
            >
              <DissolveMaterial
                baseMaterial={materials['Material.354']}
                visible={visibleItem}
                onFadeOut={onFadeOut}
                color="#0082b2"
              />
            ...
            <group name="shoes001" userData={{ name: 'shoes.001' }}>
              ...
              >
                <DissolveMaterial
                  baseMaterial={nodes.mike_jeans002.material}
                  visible={visibleItem}
                  onFadeOut={onFadeOut}
                  color="#0082b2"
                />
              ...
              >
                <DissolveMaterial
                  baseMaterial={materials['Material.357']}
                  visible={visibleItem}
                  onFadeOut={onFadeOut}
                  color="#0082b2"
                />
              ...
              >
                <DissolveMaterial
                  baseMaterial={materials['Material.356']}
                  visible={visibleItem}
                  onFadeOut={onFadeOut}
                  color="#0082b2"
                />
              ...
              >
                <DissolveMaterial
                  baseMaterial={materials['Material.355']}
                  visible={visibleItem}
                  onFadeOut={onFadeOut}
                  color="#0082b2"
                />
              ...
              >
                <DissolveMaterial
                  baseMaterial={materials['Material.335']}
                  visible={visibleItem}
                  onFadeOut={onFadeOut}
                  color="#0082b2"
                />
